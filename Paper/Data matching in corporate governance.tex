...
Merely matching on the original BoardID, however, the researcher would miss these observations.

\begin{center}
Table~\ref{table:l_1720679_1} Multiple entries per BoardID\label{table:l_1720679_1}
\input{Tables/l_1720679_1}
\end{center}

\begin{center}
Table~\ref{table:l_1720679_2} Multiple entries per BoardID\label{table:l_1720679_2}
...
%This dataset also includes a ticker symbol that may be used for an additional matching step.
%The two matches have now yielded two datasets that matches BoardEx data to CRSP's PERMCO identifier.
%The next step is to match this identifier to Compustat's GVKEY.
...
\begin{center}
Table~\ref{table:l_87054}. CRSP Daily Stock Event Name History for PERMNO 87054\label{table:l_87054}
\input{Tables/l_87054.tex}
\end{center}
...
\begin{center}
Table~\ref{table:l_87054}. Compustat Company Names File for CUSIP 088606\label{table:l_87054}
\input{Tables/l_088606.tex}
\end{center}
...
This will me the second method, and the number of matches will vary.
